...
<div class="container">
    <div id="logreg-forms">
        ...
        <form action="{{route('auth.register')}}" method="post" class="form-signup">
            @csrf
            <div class="social-login">
            ...
            <input type="text" id="user-name" name="username" class="form-control" placeholder="User Name" required="" autofocus="">
