                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item">
                            ...
                            <a href="{{route('auth.logout')}}" class="btn btn-facebook">Logout</a>
                        </li>
                    </ul>
                </div>
            </nav>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="{{route('transactions.getAll')}}" aria-expanded="false"><i class="mdi mdi-table"></i><span class="hide-menu">Transaction List</span></a></li>
                        ...
                        <li> <a class="waves-effect waves-dark" href="{{route('transactions.show')}}" aria-expanded="false"><i class="mdi mdi-earth"></i><span class="hide-menu">Chart</span></a></li>
